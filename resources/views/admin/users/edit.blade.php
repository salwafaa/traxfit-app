                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="username" id="username" required
                               ...
                               class="w-full px-4 py-3 pl-10 border border-gray-300 rounded-lg focus:outline-none focus:border-[#27124A] focus:ring-1 focus:ring-[#27124A] transition-colors duration-200">
                    </div>
                    @error('username')
            ...
            <div class="mt-10 pt-8 border-t border-gray-200">
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('admin.users.index') }}" 
                       class="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-lg transition-colors duration-200 border border-gray-300">
                        <i class="fas fa-times mr-2"></i> Batal
                    </a>
                    <button type="submit"
                            class="px-6 py-3 bg-[#27124A] hover:bg-[#3A1B6E] text-white font-semibold rounded-lg transition-colors duration-200">
