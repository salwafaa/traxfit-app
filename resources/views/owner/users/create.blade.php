    ...
    <div class="px-6 py-5 bg-[#27124A]">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-sm text-white/90">Tambah user baru dengan role Admin atau Kasir</p>
            </div>
        </div>
    </div>
</div>
        ...
        <form action="{{ route('owner.users.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="space-y-2">
                    ...
                    @error('username')
                        <div class="text-sm text-red-600 bg-red-50 p-3 rounded-lg border border-red-100 mt-2">
            ...
            <div class="mt-10 pt-8 border-t border-gray-200">
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-save mr-2 group-hover:rotate-12 transition-transform"></i> Simpan User
                    </button>
                </div>
            </div>
        </form>
